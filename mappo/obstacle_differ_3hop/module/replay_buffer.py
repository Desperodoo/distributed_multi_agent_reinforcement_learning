...
class ReplayBuffer:
    ...
    def reset_buffer(self):
        ...
        self.buffer['actor_historical_embedding'] = zero_ten(size=(self.batch_size, self.episode_limit, self.p_num, self.embedding_size, self.depth))
        self.buffer['critic_historical_embedding'] = zero_ten(size=(self.batch_size, self.episode_limit, self.p_num, self.embedding_size, self.depth))
    ...
    def store_transition(self, num_episode, episode_step, p_state, e_state, o_state, p_adj, e_adj, o_adj, actor_historical_embedding, critic_historical_embedding, v_n, a_n, a_logprob_n, r, active, win):
        ...
        self.buffer['actor_historical_embedding'][num_episode][episode_step][:self.p_num] = actor_historical_embedding
        self.buffer['critic_historical_embedding'][num_episode][episode_step][:self.p_num] = critic_historical_embedding
