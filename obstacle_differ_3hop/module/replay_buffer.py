...
class MiniBuffer:
    ...
    def reset_buffer(self, p_num, o_num, p_obs_dim, e_obs_dim, action_dim):
        ...
        self.buffer['actor_comm_embedding'] = zero_ten(size=(self.batch_size, self.episode_limit, p_num, 2 * self.args.gnn_output_dim))
        self.buffer['critic_comm_embedding'] = zero_ten(size=(self.batch_size, self.episode_limit, p_num, 2 * self.args.gnn_output_dim))
